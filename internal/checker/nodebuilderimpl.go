...
func (b *NodeBuilderImpl) getResolvedTypeWithoutAbstractConstructSignatures(t *StructuredType) *Type {
	...
	typeCopy := b.ch.newAnonymousType(t.symbol, b.ch.getResolvedMembers(t), t.CallSignatures(), core.IfElse(len(constructSignatures) > 0, constructSignatures, []*Signature{}), t.indexInfos)
...
func (b *NodeBuilderImpl) createTypeNodesFromResolvedType(resolvedType *StructuredType) *ast.NodeList {
	...
	properties := b.ch.getResolvedProperties(resolvedType)
	if len(properties) == 0 {
...
func (b *NodeBuilderImpl) createTypeNodeFromObjectType(t *Type) *ast.TypeNode {
	...
	properties := b.ch.getResolvedProperties(resolved)
